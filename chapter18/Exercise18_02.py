...
'''(Implement LinkedList) The implementations of the functions
contains(e), get(index), indexOf(e), lastIndexOf(e),
and set(index, e) are omitted in the text. Implement these methods'''
