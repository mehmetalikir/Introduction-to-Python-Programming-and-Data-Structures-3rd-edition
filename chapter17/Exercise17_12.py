...
'''(Insert-sort animation) Write a program that animates the insert-sort algorithm
Create a list that consists of 20 distinct numbers from 1 to 20 in a random order.
The elements are displayed in a histogram, as shown in Figure 17.19. Clicking the stop
button causes the program to perform an iteration of the outer loop in the algorithm
and repaints the histogram for the new list. Color the last bar in the sorted sublist.
When the algorithm is finished, clicking the Step button displays a dialog box to
inform the user'''
