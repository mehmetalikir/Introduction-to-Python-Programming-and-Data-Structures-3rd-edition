...
'''(Turtle: Selection sort animation) Write a program that animates the selection sort
...
Figure 17.16. If two elements are swapped, redisplay them in the histogram'''
