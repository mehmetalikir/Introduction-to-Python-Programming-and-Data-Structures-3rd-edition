...
'''(Display current date and time) Listing 2.7, ShowCurrentTime.py, displays the
current time. Enhance this program to display the current date and time.(Hint:
The calendar example in Listing 6.13, PrintCalendar.py, should give you some ideas on
...
def getStartDay(year, month):
    ...
    # Get total number of days from 1/1/100 to month/1/year
...
def getTotalNumberOfDays(year, month):
    ...
    # Get the total days from 18000 to 1/1/year
    ...
    # Add days from Jan to the month prior month to the calendar month
...
def main():
    ...
    month = int(input("Please enter month as number between 1 and 2: "))
