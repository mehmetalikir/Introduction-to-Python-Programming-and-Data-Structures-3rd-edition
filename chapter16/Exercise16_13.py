...
'''(Geometry: Graham’s algorithm for finding a convex hull) Section 16.10.2
introduced Graham’s algorithm for finding a convex hull for a set of points.
Implement the algorithm using the following function:
...
def main():
    points = input("Please enter the points: ").split()
