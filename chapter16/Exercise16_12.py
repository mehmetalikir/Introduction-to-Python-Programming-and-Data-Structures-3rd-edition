...
'''(Find the smallest number) Write a function that uses the divide-and-conquer approach
to find the smallest number inn a list. What is  the time complexity of this function?'''
