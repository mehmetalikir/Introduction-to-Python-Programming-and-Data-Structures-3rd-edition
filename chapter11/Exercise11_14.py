...
to a vertex. The formula to compute angles A, B, and C (see Figure 11.23b) is given
in Listing 4.2.
Hint: Use the Point class to represent a point, as described in Exercise 9.11. Create
