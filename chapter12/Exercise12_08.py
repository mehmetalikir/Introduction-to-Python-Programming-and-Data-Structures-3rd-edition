...
'''(Tkinter: Two circles intersect?) Using the Circle2D class you defined in Exercise
9.12, write a program that enables the user to specify the location and size of
