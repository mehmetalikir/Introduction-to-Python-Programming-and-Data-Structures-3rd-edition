...
'''(Tkinter: Connect Four game) In Exercise 8.20, you created a Connect Four
game that enables two players to play the game on the console. Rewrite the program
