...
'''(Tkinter: Sierpinski triangle) Revise Listing 15.9 to let the user use leftmouse/
...
class SierpinskiTriangle:
    def __init__(self):
        ...
        self.order = 0  # Initialize the order to 0

        # Bind left mouse button click to increase the order
        self.canvas.bind("<Button-1>", self.increaseOrder)
        # Bind right mouse button click to decrease the order
